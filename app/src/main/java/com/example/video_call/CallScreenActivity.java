...
import techheromanish.example.com.videochatapp.AudioPlayer;
import techheromanish.example.com.videochatapp.BaseActivity;
import techheromanish.example.com.videochatapp.R;
import techheromanish.example.com.videochatapp.SinchService;

public class CallScreenActivity extends BaseActivity {

    static final String TAG = techheromanish.example.com.videochatapp.CallScreenActivity.class.getSimpleName();
    ...
    private class UpdateCallDurationTask extends TimerTask {
        ...
        @Override
        public void run() {
            com.example.video_call.CallScreenActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    updateCallDuration();
                }
    ...
    private class SinchCallListener implements VideoCallListener {
        ...
        public void onCallEnded(Call call) {
            ...
            Toast.makeText(com.example.video_call.CallScreenActivity.this, endMsg, Toast.LENGTH_LONG).show();
